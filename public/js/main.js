...
console.log("YEEEE");
     ...
     axios.post('/subject/' + document.getElementById('myid').value, {
         Qset: qset
 ...
 function createQuiz2() {
    ...
    axios.post('/edit/' + document.getElementById('myid').value, {
        Title: title,
        Description: desc,
        Qset: qset
    }).then(function(response) {
 ...
 function evaluateQuiz() {
     ...
     axios.post('/quizups/' + document.getElementById('myid').value, {
         answers: answers
     }).then(function(response) {
         console.log(response);
     }).catch(function(error) {
